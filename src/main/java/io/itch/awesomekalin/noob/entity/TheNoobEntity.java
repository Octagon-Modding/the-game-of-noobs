...
public class TheNoobEntity extends PathfinderMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new RemoveBlockGoal(Blocks.DIRT, this, 1, (int) 3));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(NoobModItems.SALIVA.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(NoobModEntities.THE_NOOB.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
