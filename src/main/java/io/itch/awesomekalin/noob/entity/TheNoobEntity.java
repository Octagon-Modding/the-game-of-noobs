...
public class TheNoobEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(NoobModEntities.THE_NOOB, 20, 1, 1));
	}

	public TheNoobEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(NoobModEntities.THE_NOOB, world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(NoobModItems.SALIVA));
	}
	...
	public static void init() {
		SpawnPlacements.register(NoobModEntities.THE_NOOB, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
