...
import io.itch.awesomekalin.noob.entity.renderer.TheNoobRenderer;
...
public class TheNoobEntity extends NoobModElements.ModElement {
	...
	public TheNoobEntity(NoobModElements instance) {
		super(instance, 57);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TheNoobRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new BreakBlockGoal(Blocks.GRASS_BLOCK, this, 1, (int) 3));
			this.goalSelector.addGoal(5, new BreakBlockGoal(Blocks.DIRT, this, 1, (int) 3));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SalivaItem.block));
		}
