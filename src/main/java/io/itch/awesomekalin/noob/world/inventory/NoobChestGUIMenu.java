...
package io.itch.awesomekalin.noob.world.inventory;
...
public class NoobChestGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NoobChestGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(NoobModMenus.NOOB_CHEST_GUI.get(), id);
