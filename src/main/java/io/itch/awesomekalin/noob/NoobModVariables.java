...
public class NoobModVariables {
	...
	public static class WorldVariables extends WorldSavedData {
		...
		public CompoundNBT write(CompoundNBT nbt) {
			nbt.putDouble("CreativeTimer", CreativeTimer);
			nbt.putBoolean("ActivatedGauntlet", ActivatedGauntlet);
			return nbt;
		}
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				NoobMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
