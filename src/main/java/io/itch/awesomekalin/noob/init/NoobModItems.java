...
public class NoobModItems {
	...
	public static final RegistryObject<Item> NOOB_CHEST = block(NoobModBlocks.NOOB_CHEST);
	...
	public static final RegistryObject<Item> NOOB_ORE = block(NoobModBlocks.NOOB_ORE);
	public static final RegistryObject<Item> NOOB_BLOCK = block(NoobModBlocks.NOOB_BLOCK);
	...
	public static final RegistryObject<Item> THE_NOOB_SPAWN_EGG = REGISTRY.register("the_noob_spawn_egg", () -> new ForgeSpawnEggItem(NoobModEntities.THE_NOOB, -13421569, -10027009, new Item.Properties()));
	public static final RegistryObject<Item> NOOB_FOOD = REGISTRY.register("noob_food", () -> new NoobFoodItem());
	public static final RegistryObject<Item> DIRT_WOOD = block(NoobModBlocks.DIRT_WOOD);
	public static final RegistryObject<Item> DIRT_LOG = block(NoobModBlocks.DIRT_LOG);
	public static final RegistryObject<Item> DIRT_PLANKS = block(NoobModBlocks.DIRT_PLANKS);
	public static final RegistryObject<Item> DIRT_LEAVES = block(NoobModBlocks.DIRT_LEAVES);
	public static final RegistryObject<Item> DIRT_STAIRS = block(NoobModBlocks.DIRT_STAIRS);
	public static final RegistryObject<Item> DIRT_SLAB = block(NoobModBlocks.DIRT_SLAB);
	public static final RegistryObject<Item> DIRT_FENCE = block(NoobModBlocks.DIRT_FENCE);
	public static final RegistryObject<Item> DIRT_FENCE_GATE = block(NoobModBlocks.DIRT_FENCE_GATE);
	public static final RegistryObject<Item> DIRT_PRESSURE_PLATE = block(NoobModBlocks.DIRT_PRESSURE_PLATE);
	public static final RegistryObject<Item> DIRT_BUTTON = block(NoobModBlocks.DIRT_BUTTON);
	public static final RegistryObject<Item> NOOB_WOOD = block(NoobModBlocks.NOOB_WOOD);
	public static final RegistryObject<Item> NOOB_LOG = block(NoobModBlocks.NOOB_LOG);
	public static final RegistryObject<Item> NOOB_PLANKS = block(NoobModBlocks.NOOB_PLANKS);
	public static final RegistryObject<Item> NOOB_LEAVES = block(NoobModBlocks.NOOB_LEAVES);
	public static final RegistryObject<Item> NOOB_STAIRS = block(NoobModBlocks.NOOB_STAIRS);
	public static final RegistryObject<Item> NOOB_SLAB = block(NoobModBlocks.NOOB_SLAB);
	public static final RegistryObject<Item> NOOB_FENCE = block(NoobModBlocks.NOOB_FENCE);
	public static final RegistryObject<Item> NOOB_FENCE_GATE = block(NoobModBlocks.NOOB_FENCE_GATE);
	public static final RegistryObject<Item> NOOB_PRESSURE_PLATE = block(NoobModBlocks.NOOB_PRESSURE_PLATE);
	public static final RegistryObject<Item> DIRT_WOOD_PICKAXE = REGISTRY.register("dirt_wood_pickaxe", () -> new DirtPickaxeItem());
	public static final RegistryObject<Item> NOOB_BUTTON = block(NoobModBlocks.NOOB_BUTTON);
	...
	public static final RegistryObject<Item> DIRT_SAPLING = block(NoobModBlocks.DIRT_SAPLING);
	public static final RegistryObject<Item> NOOB_COBBLESTONE = block(NoobModBlocks.NOOB_COBBLESTONE);
	public static final RegistryObject<Item> NOOB_STONE = block(NoobModBlocks.NOOB_STONE);
