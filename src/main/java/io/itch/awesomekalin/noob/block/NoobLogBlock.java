...
public class NoobLogBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_log")
	public static final Block block = null;
	public NoobLogBlock(NoobModElements instance) {
		super(instance, 76);
	}
