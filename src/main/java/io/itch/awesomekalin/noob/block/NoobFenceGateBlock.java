...
public class NoobFenceGateBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_fence_gate")
	public static final Block block = null;

	public NoobFenceGateBlock(NoobModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("noob_fence_gate");
		}
