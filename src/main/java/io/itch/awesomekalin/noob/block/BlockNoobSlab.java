...
public class BlockNoobSlab extends ElementsNoobMod.ModElement {
	@GameRegistry.ObjectHolder("noob:noob_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("noob:noob_slab_double")
	public static final Block block_slab_double = null;
	public BlockNoobSlab(ElementsNoobMod instance) {
		super(instance, 76);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("noob_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("noob_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("noob:noob_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("noob_slab");
