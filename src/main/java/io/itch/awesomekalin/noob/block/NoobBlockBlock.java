...
public class NoobBlockBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_block")
	public static final Block block = null;

	public NoobBlockBlock(NoobModElements instance) {
		super(instance, 19);
	}
