...
public class NoobFenceBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_fence")
	public static final Block block = null;
	public NoobFenceBlock(NoobModElements instance) {
		super(instance, 81);
	}
