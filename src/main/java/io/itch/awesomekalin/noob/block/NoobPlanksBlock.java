...
public class NoobPlanksBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_planks")
	public static final Block block = null;
	public NoobPlanksBlock(NoobModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 1.7230475324955523f).lightValue(0)
