...
import io.itch.awesomekalin.noob.procedure.ProcedureNoobSaplingPlantRightClicked;
import io.itch.awesomekalin.noob.creativetab.TabNoobTab;
import io.itch.awesomekalin.noob.ElementsNoobMod;

@ElementsNoobMod.ModElement.Tag
public class BlockNoobSapling extends ElementsNoobMod.ModElement {
	@GameRegistry.ObjectHolder("noob:noob_sapling")
	public static final Block block = null;
	public BlockNoobSapling(ElementsNoobMod instance) {
		super(instance, 171);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("noob:noob_sapling", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("noob_sapling");
			setRegistryName("noob_sapling");
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				ProcedureNoobSaplingPlantRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
