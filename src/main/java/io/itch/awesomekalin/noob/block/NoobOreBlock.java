...
public class NoobOreBlock extends NoobModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("noob_ore", "noob_ore", blockAt -> {
			...
			}), block.getDefaultState(), 32), Placement.COUNT_RANGE, new CountRangeConfig(32, 1, 1, 256)));
		}
	}
}
