...
public class BlockDirtSlab extends ElementsNoobMod.ModElement {
	@GameRegistry.ObjectHolder("noob:dirt_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("noob:dirt_slab_double")
	public static final Block block_slab_double = null;
	public BlockDirtSlab(ElementsNoobMod instance) {
		super(instance, 60);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dirt_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("dirt_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("noob:dirt_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("dirt_slab");
