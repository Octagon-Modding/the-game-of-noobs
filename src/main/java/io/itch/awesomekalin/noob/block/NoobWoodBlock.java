...
public class NoobWoodBlock extends NoobModElements.ModElement {
	@ObjectHolder("noob:noob_wood")
	public static final Block block = null;
	public NoobWoodBlock(NoobModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 1.1486983549970349f).lightValue(0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("noob_wood");
		}
