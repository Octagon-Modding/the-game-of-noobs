...
public class DirtPickaxeItem extends NoobModElements.ModElement {
	@ObjectHolder("noob:dirt_wood_pickaxe")
	public static final Item block = null;

	public DirtPickaxeItem(NoobModElements instance) {
		super(instance, 87);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("dirt_wood_pickaxe"));
	}
}
